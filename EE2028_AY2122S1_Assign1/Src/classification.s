...
classification:
	...
	LDR R1,#0 ;loop counter, since centroids already loaded, can discard
L1:
	...
	BCS L2:
	BCC L3:
	STR R12,[OUT,#4]; store the classification in OUT
	;loop logic
...
L2:
	...
	IFE AL;if R9 is larger than R11
	LDRCS R12,#2; R12(Classification) = 2
	LDRCC R12,#0; R12(Classification) = 0
	BX LR
L3:
	CMP R10,R11;find smaller distance
	IFE AL;if R10 is larger than R11
	LDRCS R12,#2; R12(Classification) = 2
	LDRCC R12,#1; R12(Classification) = 0
	BX LR
